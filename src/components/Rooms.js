...
const Rooms = () => {
  return (
    <div className="max-w-[1400px] mx-auto h-[500px] bg-blue-100 my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-3">
      <div className="lg:top-20 relative lg:col-span-1 col-span-2">
        <h3 className="text-2xl font-bold">Find Interior Rooms</h3>
        <p className="pt-4">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Rem qui non
          quod placeat consectetur fugit consequuntur similique unde quibusdam
          ipsam.
        </p>
      </div>
