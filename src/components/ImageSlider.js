...
const ImageSlider = () => {
  ...
  return (
    <div className="max-w-[1400px] m-auto h-[580px] w-full py-16 px-4 relative group">
      <div
      ...
      <div
        onClick={prevSlide}
        className="absolute top-[50%] translate-y-[-50%] -translate-x-0 left-5 text-2xl rounded-full p-2 group-hover:bg-black/20 text-white cursor-pointer"
      >
